...
echo -e '1. pip uninstall -y numpy'
pip uninstall -y numpy
echo -e '2. apt -y install python-numpy'
apt -y install python-numpy
echo -e '3. pip install --upgrade --force-reinstall numpy==1.26.1'
pip install --upgrade --force-reinstall numpy==1.26.1
