...
AIS_HA_VERSSION="2022.9.4"
AIS_ZIGBEE_VERSION='"version": "1.27.2",'
...
curl -o "/data/data/com.termux/files/home/AIS/beta_wheelhouse.tar.7z" -# -L  https://github.com/sviete/AIS-utils/blob/master/releases/beta_wheelhouse.tar.7z?raw=true
...
7z x -mmt=2 -o/data/data/com.termux/files/home/AIS/ /data/data/com.termux/files/home/AIS/beta_wheelhouse.tar.7z -y
...
if  grep -q "$AIS_ZIGBEE_VERSION" '/data/data/com.termux/files/home/zigbee2mqtt/package.json' ; then
  ...
  curl -H 'Cache-Control: no-cache' -o "/data/data/com.termux/files/home/AIS/zigbee_update.zip" -L https://github.com/sviete/AIS-utils/blob/master/releases/zigbee_beta.zip?raw=true
