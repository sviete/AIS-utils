...
echo -e '\e[38;5;220m START bulding version \e[30;48;5;208m AIS PROD ' $AIS_HA_VERSSION '\e[0m'
SECONDS=0
echo -e '\e[38;5;220m AIS cleenup ... \e[0m'
cd ~/AIS-home-assistant
rm -rf wheels
rm -rf prod_wheelhouse.tar.7z
...
cd ~/AIS-home-assistant
7za a -m0=lzma2 prod_wheelhouse.tar.7z wheels

echo -e '\e[38;5;220m Uploading AIS ... \e[0m'
cd ~/AIS-utils
git pull
cp ~/AIS-home-assistant/prod_wheelhouse.tar.7z releases/
git add releases/prod_wheelhouse.tar.7z
git commit -m 'prod_wheelhouse'
git push
