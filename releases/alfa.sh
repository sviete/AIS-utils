...
# AIS VERSIONS
AIS_VERSSION="21.11.04"
AIS_HA_VERSSION="2021.11.2b0"
...
curl -o "/data/data/pl.sviete.dom/files/home/AIS/pre_alfa_wheelhouse.tar.7z" -L  https://github.com/sviete/AIS-utils/blob/master/releases/alfa_wheelhouse.tar.7z?raw=true
...
7z x -mmt=2 -o/data/data/pl.sviete.dom/files/home/AIS/ /data/data/pl.sviete.dom/files/home/AIS/alfa_wheelhouse.tar.7z -y
