...
3. change /framework-res/res/xml/config_webview_packages.xml

4. apktool b --copy-original framework-res

5. adb push framework-res/dist/framework-res.apk /sdcard
...
9. cp /sdcard/framework-res.apk /system/framework/framework-res.apk.temp

10. chmod 644 framework-res.apk.temp

11. mv framework-res.apk.temp framework-res.apk
