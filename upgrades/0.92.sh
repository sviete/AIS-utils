...
curl -o "/sdcard/ais-dom-0.92.2.tar.gz" -L https://raw.githubusercontent.com/sviete/AIS-utils/master/patches/scripts/ais-dom-0.92.2.tar.gz &&
pip install /sdcard/ais-dom-0.92.2.tar.gz -U &&
